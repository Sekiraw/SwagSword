	...
	:	font(font), showList(false), keytimeMax(1.f), keytime(0.f)
{
	...
	this->activeElement = new gui::Button(
		...
		//Font
		sf::Color(255, 255, 255, 150), //Idle
		sf::Color(250, 250, 150, 20), //Hover
	...
	for (size_t i = 0; i < nrOfElements; i++)
	{
		this->list.push_back(
			new gui::Button(
			x, y + ((i+1) * height), width, height, //x, y, width, height
			&this->font, list[i], 14,
			//Font
			sf::Color(255, 255, 255, 200), //Idle
			sf::Color(250, 250, 150, 250), //Hover
			sf::Color(20, 20, 20, 50), //Active
			//Box
			sf::Color(100, 100, 100, 200), //Idle
			sf::Color(150, 150, 150, 200), //Hover
			sf::Color(20, 20, 20, 200),
			//Outline
	...
	: keytimeMax(1.f), keytime(0.f)
{
	...
	this->hide_btn = new gui::Button(x, y, 50.f, 50.f, //x, y, width, height
		&font, text, 16,
		//Font
		sf::Color(255, 255, 255, 200),
...
void gui::TextureSelector::update(const sf::Vector2i& mousePosWindow, const float& dt)
{
	...
	if (this->hide_btn->isPressed() || sf::Keyboard::isKeyPressed(sf::Keyboard::H))
	{
		if (this->getKeyTime()) {
			if (this->hidden)
			{
